...
class VillageAppContract(unittest.TestCase):
    ...
    def test_game_uses_local_babylon_engine_with_3d_camera_lighting_and_postprocess(self):
        ...
        self.assertIn("pipeline.depthOfFieldEnabled = true", js)
        self.assertIn("pipeline.depthOfField.focusDistance = 6500", js)
        self.assertIn("pipeline.depthOfField.fStop = 7.5", js)
        ...
        self.assertIn("new BABYLON.ShaderMaterial('world-sunshaft-mat'", js)
        self.assertIn("const shaftConfigs = [", js)
        self.assertIn("width:.9", js)
        self.assertIn("width:4.8", js)
        self.assertIn("intensity", js)
        self.assertIn("ps.minEmitBox = new BABYLON.Vector3(-40", js)
        self.assertIn("ps.emitRate = 48", js)
        self.assertNotIn("new BABYLON.Layer('visible-sunshafts'", js)
    ...
    def test_dialogue_opens_fullscreen_character_cg_and_completes_story(self):
        ...
        self.assertIn("left:50%;top:0;width:75%;height:auto", css)
        ...
        self.assertNotIn("scale(1.38)", css)
