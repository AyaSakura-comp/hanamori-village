...
- The scene uses real Babylon.js hemispheric/directional lighting, shadow maps, low depth-of-field, restrained bloom, ACES tone mapping, color grading, and vignette. The street uses Poly Haven `cobblestone_floor_001` CC0 PBR maps with shallow parallax occlusion so grazing side light reveals stone relief. Characters, NPCs, buildings, and props are vertical billboard planes; ground, roads, river, bridge, and collisions are true 3D meshes.
