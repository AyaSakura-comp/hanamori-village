...
|---|---|---|
| `assets/hero-walk.png` | `288 × 512`; 3 columns × 4 rows; each frame `96 × 128`; rows are down, left, right, up | Built from the user-supplied `walk_final.gif` step poses in cols 0/2 and `frontwalk_tile2.jpg`'s middle pose in col 1. Loaded as `heroWalk`; movement cycles at 8 fps and every stop must use col 1. |
