...
- The village is staged at golden dusk: a blue-violet-to-amber sky gradient, camera-visible layered warm/cool clouds, camera-side orange directional sunlight, six restrained diagonal god-rays anchored at varied world-X positions, three warm facade spotlights with modest specular highlights, and sparse drifting illuminated dust distributed across the full town. Rays and dust must remain world-space atmosphere and must never follow the player or camera. Keep all atmospheric layers inexpensive enough for iPhone.
