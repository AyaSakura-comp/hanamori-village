...
- Foreground billboards sit at world Z `17.2`, sitting slightly higher while still using only the lower frame as a framing layer so the central walking lane remains unobstructed. Fill the full lower edge with eighteen distinct types at roughly four-world-unit intervals: ivy, garden, gabled, red-roof and moon cottages; merchant wagons; bakery; smithy; moss workshop; fishing shack; stable; potion shop; honey lodge; boathouse; shrine; greenhouse; and flower well. Avoid repeating the backdrop building set.
