...
- Preserve an authored `2556 × 1179` iPhone 14 Pro native landscape frame in every device orientation; portrait devices display the complete landscape composition with neutral letterboxing instead of cropping or switching to portrait framing.
