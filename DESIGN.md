...
- **Dialogue portraits:** show only half-body compositions above the story panel: the protagonist is always anchored on the left and angled slightly right, while the active NPC stays on the right and angles slightly left. Normalize both to equal 900×900 transparent crops and comparable visual scale. Keep the bottom dialogue box compact (about 98 px minimum height at the reference landscape frame), rather than covering a third of the scene. Source PNGs stay transparent and may retain full-body resolution, but the UI crops them around the waist without a white matte.
